...
/** Inline stroke icons — no icon-font dependency, scales with font size. */
const PATHS: Record<string, string> = {
  ...
  brain: 'M12 4.5a2.5 2.5 0 0 0-5 0v.2A2.5 2.5 0 0 0 4.5 9 2.5 2.5 0 0 0 5 13.9V15a3 3 0 0 0 3 3h.5A2.5 2.5 0 0 0 12 20.5zM12 4.5a2.5 2.5 0 0 1 5 0v.2A2.5 2.5 0 0 1 19.5 9a2.5 2.5 0 0 1-.5 4.9V15a3 3 0 0 1-3 3h-.5a2.5 2.5 0 0 1-3.5 2.5z',
  scroll: 'M4 6h12v13a2 2 0 0 0 2 2H6a2 2 0 0 1-2-2zM16 6V4a2 2 0 0 1 4 0v2zM7 10h6M7 14h6',
  ...
  transfer: 'M17 3v12M17 3l-4 4M17 3l4 4M7 21V9M7 21l-4-4M7 21l4-4',
  ...
  branch: 'M6 3v12M18 6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM6 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM18 9a9 9 0 0 1-9 9',
  flag: 'M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1zM4 22v-7',
  bookmark: 'M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z',
  star: 'm12 2 3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z',
  pin: 'M12 17v5M9 10.76V3h6v7.76l3 3.24H6z',
  ...
  sparkle: 'm12 3 1.9 5.6L19.5 10l-5.6 1.9L12 17.5l-1.9-5.6L4.5 10l5.6-1.4zM19 15l.8 2.2L22 18l-2.2.8L19 21l-.8-2.2L16 18l2.2-.8z',
  menu: 'M3 12h18M3 6h18M3 18h18',
  grid: 'M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z',
  flask: 'M9 3v6.5L4 19a2 2 0 0 0 1.7 3h12.6a2 2 0 0 0 1.7-3l-5-9.5V3M8 3h8M7.5 14h9',
};
